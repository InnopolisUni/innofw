                ...
                configurations_html.append(
                    dbc.Row(
                        [
                            html.Div(
                                ...
                                children=[
                                    html.Div(
                                        ...
                                        children=[
                                            html.Div(
                                                className="modal_configuration_parameters",
                                                children=[
                                                    dbc.Row(
                                                        [
                                                            dbc.Col(
                                                                dbc.Button(
                                                                    className="bi bi-plus rounded-circle modalEndwagon",
                                                                    outline=True,
                                                                    color="primary",
                                                                ),
                                                                width="auto",
                            ...
                            dbc.Col(
                                dbc.Button(
                                    className="bi bi-plus rounded-circle",
                                    outline=True,
                                    color="primary",
                                ),
                                width="auto",
...
def simplify_dict(dict):
    ...
    for k, v in dict.items():
        if type(v) is list:
            intermediate_dict = {
                key: value for element in v for key, value in element.items()
            }
...
def layout(config_name=None):
    ...
    html_components = [
        dbc.Row(
            [
                dbc.Col(
                    [html.H4("Experiment Configurator", style={"height": 40})]
                ),
                dbc.Col(
                    [
                        html.Div(
                            html.Img(
                                src=dash.get_asset_url("_innofw_.svg"),
            ...
            style={"margin-top": 10, "margin-bottom": 10, "margin-right": 15},
        ),
        html.Br(),
        dbc.Input(
            id="config_name",
    ...
    html_components.append(
        dbc.Row(
            [
                dbc.Col(
                    dbc.Button(
                        className="bi bi-plus rounded-circle endwagon",
                        outline=True,
                        color="primary",
                    ),
                    width="auto",
                ...
                dbc.Row(
                    html.Div(
                        ...
                        children=[
                            ...
                            dbc.ModalBody(
                                f"Configuration {config_name} is saved"
                            ),
                            dbc.ModalFooter(
                                [
                                    dbc.Button(
                        ...
                        dbc.ModalFooter(
                            [
                                dcc.Link(
                                    ...
                                    href=f"/delete_config/{config_name}",
                                    refresh=True,
                                ),
                                dbc.Button(
                                    "Cancel",
    ...
    config_edition_page_layout = html.Div(
        children=html_components,
        className="configuration_parameters",
