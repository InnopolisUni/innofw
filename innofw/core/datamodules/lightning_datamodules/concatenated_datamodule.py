...
class ConcatenatedLightningDatamodule(BaseLightningDataModule):
    ...
    def setup_train_test_val(self, **kwargs):
        ...
        # self.train_ds = self.datamodules[0].train_dataset
        # self.test_ds = self.datamodules[0].train_dataset
        # self.val_ds = self.datamodules[0].train_dataset
        print(type(self.train_ds),'sdasdsadSDDSADSA')
